...
**             ----------------------------------------------------
**                       1             |  GPIOB6_ANA13_SDA_RXD_CMP0_P2_CLKIN
**             ----------------------------------------------------
**
**         Port name                   : GPIOB
**
...
**     Contents  :
**         PutVal - void LCD_DC_PutVal(bool Val);
**
...
#define LCD_DC_PIN_MASK         ((byte)64) /* Pin mask */


/*
** ===================================================================
**     Method      :  LCD_DC_PutVal (component BitIO)
**
**     Description :
...
** ===================================================================
*/
#define LCD_DC_PutVal(Val) BitIO__PutVal(BitIO__GPIO_B_DR, LCD_DC_PIN_MASK, Val>0?SET:CLR, 0, 0)
