...
**     Contents  :
**         PutVal - void LCD_SCLK_PutVal(bool Val);
**
...
#define LCD_SCLK_PIN_MASK       ((byte)32) /* Pin mask */


/*
** ===================================================================
**     Method      :  LCD_SCLK_PutVal (component BitIO)
**
**     Description :
...
** ===================================================================
*/
#define LCD_SCLK_PutVal(Val) BitIO__PutVal(BitIO__GPIO_B_DR, LCD_SCLK_PIN_MASK, Val>0?SET:CLR, 0, 0)
