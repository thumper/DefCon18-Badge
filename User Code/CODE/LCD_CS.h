...
**     Contents  :
**         PutVal - void LCD_CS_PutVal(bool Val);
**
...
#define LCD_CS_PIN_MASK         ((byte)2) /* Pin mask */


/*
** ===================================================================
**     Method      :  LCD_CS_PutVal (component BitIO)
**
**     Description :
...
** ===================================================================
*/
#define LCD_CS_PutVal(Val) BitIO__PutVal(BitIO__GPIO_B_DR, LCD_CS_PIN_MASK, Val>0?SET:CLR, 0, 0)
