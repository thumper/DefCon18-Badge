...
**         User handling procedure     : EINT_SW1_OnInterrupt
**
**         Used pin                    :
**             ----------------------------------------------------
**                Number (on package)  |    Name
**             ----------------------------------------------------
**                       11            |  GPIOC1_PGA0NON_INV_ANA7_CMP2_M2
**             ----------------------------------------------------
**
**         Port name                   : GPIOC
**
...
**     Contents  :
**         GetVal - bool EINT_SW1_GetVal(void);
**
...
#define EINT_SW1_PIN_MASK       ((byte)2) /* Pin mask */

#define EINT_SW1_GetVal() ((bool)(getRegBits(GPIO_C_RAWDATA,EINT_SW1_PIN_MASK)))
/*
** ===================================================================
**     Method      :  EINT_SW1_GetVal (component ExtInt)
**
**     Description :
